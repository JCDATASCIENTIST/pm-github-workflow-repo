...
|---|---|---|---|
| 2026-03-03 | Recorded 0.71 baseline | First scored run vs. support logs | Below 0.80 target |
| 2026-03-17 | Added criterion 4 (no full card/account numbers) | Security review found a leaked PAN | Raised bar — score dipped to 0.68 next run |
| 2026-04-07 | Raised target 0.80 → 0.85 | Prompt fix landed; run hit 0.86, sustained 3 weeks | New floor for rollout |
